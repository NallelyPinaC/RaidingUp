...
public class MapClientActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void limitSearch(){
        LatLng northSide = SphericalUtil.computeOffset(mCurrentLantLng, 5000, 0);
        LatLng southSide = SphericalUtil.computeOffset(mCurrentLantLng, 5000, 180);
    ...
    private void instanceAutocompleteOrigin(){
        ...
        mAutocomplete.setHint("Lugar de partida");
